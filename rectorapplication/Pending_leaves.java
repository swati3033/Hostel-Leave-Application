...
public class Pending_leaves extends AppCompatActivity {

    private RecyclerView recyclerView;
    private LeaveAdapter leaveAdapter;
    private List<Leave> leaveList = new ArrayList<>();
    private static final String url = "http://192.168.43.20/hostel_management/PendingLeaves.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pending_leaves);
