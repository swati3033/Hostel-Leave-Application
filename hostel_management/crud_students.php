...
<div class="sidebar">
      <ul>
        ...
        <li><a href="registration_request.php">Registration request</a></li>
    ...
    <br><br>
        ...
        <table  id="tabledata" class=" table table-striped table-hover table-bordered">
            ...
            <?php 
                ...
                $select_query="select * from hostellers";
                ...
                while($table=mysqli_fetch_array($result))
                {
                    ...
                    $emailid=$table['email'];
                    $adrs=$table['address'];
                    $scno=$table['stud_phone'];
                    $pcno=$table['parent_phone'];
                    $hname=$table['hostel_name'];
                    $roomno=$table['room_no'];
                    ...
                    <td><center><h4>' .$roomno.'</h4></center></td>
                    <td><center><h4><button class="btn btn-primary"><a href="update_students.php? updateid='.$id.'" class="text-light">Update</a></button>
                    <button class="btn btn-danger"><a href="delete_students.php? deleteid='.$id.'" class="text-light">Delete</a></button>
