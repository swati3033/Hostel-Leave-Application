<?php 
    ...
    $query="select * from hostel where h_id='$update_id'";
    ...
    if(isset($_POST['update']))
    {
        ...
        $update_query="update hostel set hostel_name='$c_name' where h_id='$update_id'";
...
<div class="sidebar">
      <ul>
        ...
        <li><a href="#settings">Leave app. requests</a></li>
